...
def insert_student():
    ...
    try:
        db = mysql.connector.connect(user='root', password='my-secret-pw', host='localhost', database='school_management')
        cursor = db.cursor()
